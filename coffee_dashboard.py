...
def logic_clean_data(df):
    ...
    for col in df.columns:
        if '商品类别' in col or '分类' in col: rename_map[col] = '商品类别'
        elif '门店' in col: rename_map[col] = '门店名称'
        elif '周期' in col or '日期' in col: rename_map[col] = '统计周期'
        elif '实收' in col or '金额' in col: rename_map[col] = '销售金额'
        elif '销量' in col or '数量' in col: rename_map[col] = '销售数量'
